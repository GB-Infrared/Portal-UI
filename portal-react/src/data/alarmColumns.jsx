 ...
 * column is one edit rather than two that can drift apart. Every column is
 * always shown: an alarm log is read across the row, so one hidden is a fact
 * missing from the answer rather than clutter removed from it.
 *
...
export const ALARM_COLUMNS = [
  { key: 'recv', label: 'Received Time', cls: 'ts',
